...
- clean-code.md, typescript-patterns.md, api-design.md

**When to use**: Delegated backend, or DevOps tasks within a larger workflow
...
✅ **Kebab-case** - `devops-specialist.md`  
✅ **Descriptive** - Clear purpose  
✅ **Suffix** - Use `-specialist`, `-agent`, `-writer` as appropriate

### Context Names

✅ **Kebab-case** - `typescript-patterns.md`  
...
# Subagent path
"subagents/development/devops-specialist" → ".opencode/agent/subagents/development/devops-specialist.md"
...
```markdown
<!-- Context: development/typescript-patterns | Priority: high -->
```

Loads: `.opencode/context/typescript-patterns.md`
...
- `subagents/development/devops-specialist`
- `content/copywriter`
