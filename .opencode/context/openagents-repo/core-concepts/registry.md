...
```json
{
  ...
  "description": "Expert in TypeScript, Node.js, and backend patterns",
...
ERROR: Duplicate ID: devops-specialist
...
- devops-specialist: TypeScript, Node.js, backend patterns
...
```
User installs: devops-specialist
  ↓
