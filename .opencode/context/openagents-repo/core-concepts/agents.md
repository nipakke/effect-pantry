...
- `devops-specialist.md` - TypeScript, Node.js, infrastructure
...
| **Example**    | `devops-specialist`   | `tester`           |
...
# Full category path
"development/devops-specialist" → resolves to → ".opencode/agent/subagents/development/devops-specialist.md"
...
- **Category agents**: `{domain}-specialist.md` (e.g., `devops-specialist.md`)
