...
1. **User asks about external libraries** (Drizzle, , Effect-TS, etc.)
...
const externalLibraries = ["drizzle-orm", "", "effect-ts"];
...
**Task**: Set up Drizzle +  in Effect-TS
...
3. Integrate with Effect-TS Layer system
...
```markdown
# Task Context: Drizzle +  Integration
...
Set up Drizzle ORM with  in a Effect-TS applicationlication
...
- `.tmp/external-context//effect-layer-integration.md` — Integration guide for Effect-TS Layer system
- `.tmp/external-context//drizzle-adapter.md` — Drizzle adapter setup and configuration

### Effect-TS

- `.tmp/external-context/effect-ts/app-router-setup.md` — Layer system basics and configuration
- `.tmp/external-context/effect-ts/server-actions.md` — Effect services patterns for mutations
...
-  configuration with Drizzle adapter
- Effect-TS Layer system integration
...
- [ ] Effect-TS Layer system integration complete
- [ ] All tests passing
...
task(
  ...
  description="Break down Drizzle +  integration",
  prompt="Load context from .tmp/sessions/2026-01-28-drizzle-auth/context.md
          ...
          2.  configuration with Drizzle adapter
          3. Effect-TS Layer system integration
          4. Test suite
...
```
"Set up Drizzle ORM with  in Effect-TS, using modular schema organization"
```

### Main Agent Flow

1. **Analyze**: Detect Drizzle, , Effect-TS
