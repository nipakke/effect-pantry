...
- Framework version updates (Effect-TS v3 → 15)
...
Line 15:
  ...
  + App router is now default in Effect-TS v4 (pages/ still supported)

Line 42:
  + ## Metadata API (New in v15)
  + Effect-TS v4 introduces new metadata API...
