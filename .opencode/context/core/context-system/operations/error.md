...
```
Would update development/errors/typescript-errors.md:
...
- `typescript-errors.md` - All TypeScript errors
- `effect-errors.md` - All Effect-TS errors
...
```bash
/context error for "Hydration failed in Effect-TS"
```
