...
```
/context extract from https://effect.website/docs
  ↓
...
Agent: "Would create in development/:
  ...
  errors/typescript-errors.md (124 lines)
...
Files created:
  ...
  - development/errors/typescript-errors.md
...
```
/context update for Effect-TS v4
  ↓
Agent: "What changed in Effect-TS v4?
  [A] API changes
  [B] Deprecations
  [C] New features
  [D] Breaking changes
...
New features: New metadata API, Effect services stable
...
```
Agent: "Searching for files referencing Effect-TS...
...
Found 5 files with 17 references:
  ...
  📄 guides/setting-up-effect.md (2 references, 132 lines)
  📄 errors/effect-errors.md (1 reference, 98 lines)
  📄 lookup/effect-commands.md (4 references, 54 lines)
...
Line 15:
  ...
  + App router is now default in Effect-TS v4 (pages/ still supported with opt-in)

Line 42:
  + ## Metadata API (New in v15)
  +
  + Effect-TS v4 introduces new metadata API for SEO optimization.
  + Replaces Head component with metadata exports.

Line 87:
  - **Reference**: https://effect.org/docs/app
  + **Reference**: https://effect.org/docs/15/app

━━━ examples/app-router-example.md ━━━

Line 8:
  - // Optional: use Layer system
  + // Default in Effect-TS v4+
...
Line 67:
  ...
  +
  + **Migration Steps**:
  + 1. Update to Effect-TS v4: `npm install next@15`
  + 2. For pages router: Add `pages: true` to next.config.js
  + 3. Update metadata: Replace Head with metadata exports
  +
  + **Reference**: https://effect.org/docs/15/upgrade-guide

━━━ lookup/effect-commands.md ━━━
...
```
Agent: "Creating backup...
💾 Backup: .tmp/backup/update-effect-2026-01-06-143530/

Updating files...
✅ Updated 5 files
📝 Modified 17 references
🔄 Added migration notes to errors/effect-errors.md
...
Summary of changes:
  ...
  - guides/setting-up-effect.md: 1 update (132 → 133 lines)
  - errors/effect-errors.md: Added migration section (98 → 125 lines)
  - lookup/effect-commands.md: 2 updates (54 → 56 lines)

All files still under 200 line limit ✓

Rollback available at: .tmp/backup/update-effect-2026-01-06-143530/"
```
...
Found 1 similar error:
  📄 development/errors/typescript-errors.md (Line 45)
     ## Error: Cannot read property 'X' of undefined
     Covers: General undefined property access in TypeScript
     Frequency: common
...
```
Agent: "Options:
  [A] Add as new error to typescript-errors.md
...
Which framework/category?
  [1] TypeScript (typescript-errors.md)
...
```
Agent: "Would update development/errors/typescript-errors.md:
...
Agent: "Updating development/errors/typescript-errors.md...

✅ Updated error in development/errors/typescript-errors.md
