...
**Full-stack development:** OAC handles end-to-end development work. The agents coordinate to build complete features from infrastructure to business logic.
...
1. What's your tech stack? (Effect-TS + TypeScript + PostgreSQL + Drizzle)
2. Show an API endpoint example (paste your code)
3. Show a module/service example (paste your code)
4. What naming conventions? (kebab-case, PascalCase, camelCase)
5. Any code standards? (TypeScript strict, Effect Schema, etc.)
...
> "How do I implement authentication with Effect-TS?"  # Questions
...
> "Create a user authentication system"                 # Backend features
...
- Plus category specialists: devops, copywriter, technical-writer, data-analyst
...
- **External libraries** - Integration guides (Effect-TS, Drizzle, Zod, etc.)
...
- Your tech stack (Effect-TS + TypeScript + PostgreSQL)
- Your API pattern (Effect Schema validation, typed error handling)
- Your service pattern (functional, layered, Effect-managed)
- Your naming conventions (kebab-case files, PascalCase types)
